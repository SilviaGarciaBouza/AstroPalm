package com.github.horosapp.domain

import com.github.horosapp.R

//sealed pq es fijo el numero(int pq le envío referencias)
sealed class HoroscopeInfo(val img:Int, val name:Int) {
    ...
    object Sagittarius: HoroscopeInfo(R.drawable.sagi, R.string.sagittarius)

    object Capricorn: HoroscopeInfo(R.drawable.capri, R.string.capricorn)

    object Aquarius: HoroscopeInfo(R.drawable.acuario, R.string.aquarius)
